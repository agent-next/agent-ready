...
import { loadProfile, buildScanContext } from 'agent-ready';
import type { CheckConfig, Level } from 'agent-ready';
...
export class OrchestratorAgent {
  ...
  async execute(options: ScanOptions): Promise<EnhancedReport> {
    ...
    const evaluation = this.evaluator.evaluate(pillarResults);
